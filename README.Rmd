...
```{r "pair_umap", fig.width = 6.5, fig.height = 5, echo = FALSE}
# Plot colors
...
```{r "chains_umap", fig.width = 6.5, fig.height = 5, echo = FALSE}
# Plot colors
...
```{r "abund_plots", fig.width = 8, fig.height = 4}
plot_abundance(
  sobj_in       = so_tcr,        # Seurat object
  clonotype_col = "cdr3",        # meta.data column containing clonotype IDs
  cluster_col   = "orig.ident",  # meta.data column containing cell labels
...
```{r "usage_plots_1", fig.width = 6, fig.height = 3}
plot_usage(
  sobj_in     = so_tcr,                    # Seurat object
