...
paths        <- here("data/tcr", str_c(samples, "_TCR"))
...
# Plot colors
chains_cols <- so_tcr$uniq_chains %>%
  unique() %>%
  na.omit()
...
plot_usage(
  ...
  plot_colors = ito_cols,
  n_genes     = 10             # Number of CDR3 sequences to plot
) +
