...
```{bash}
wget -nc -q https://djvdj-data.s3.us-west-2.amazonaws.com/splenocytes.zip

unzip -n -qq splenocytes.zip
```
...
so <- "splenocytes/BL6_GEX/filtered_feature_bc_matrix" %>%
  Read10X() %>%
  CreateSeuratObject()

# Add V(D)J data to object
so_vdj <- so %>%
  import_vdj(vdj_dir = "splenocytes/BL6_BCR")
```
...
# Load GEX data
gex_dirs <- c(
  "splenocytes/BL6_GEX/filtered_feature_bc_matrix",
  "splenocytes/MD4_GEX/filtered_feature_bc_matrix"
)
...
# Load GEX data
gex_dirs <- c(
  BL6 = "splenocytes/BL6_GEX/filtered_feature_bc_matrix",
  MD4 = "splenocytes/MD4_GEX/filtered_feature_bc_matrix"
)
...
tcr_dirs <- c(
  MD4 = "splenocytes/MD4_TCR",
  BL6 = "splenocytes/BL6_TCR"
)
