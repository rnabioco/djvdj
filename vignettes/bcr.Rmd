...
For each 'calc' function provided by djvdj, there is a matching 'plot' function that will generate a summary plot. The `calc_abundance()` function will plot clonotypes ranked by abundance.
...
plot_abundance(
  ...
  n_labels    = 0,               # Number of top clonotypes to label
